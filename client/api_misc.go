...
@return string
*/
func (a *MiscApiService) HelpGet(ctx context.Context) (string, *http.Response, error) {
	var (
...
@return string
*/
func (a *MiscApiService) SwaggerYamlGet(ctx context.Context) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
